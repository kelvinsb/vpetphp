...
CREATE TABLE `pet` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_pet_usuario1_idx` (`usuario_id`),
  CONSTRAINT `fk_pet_usuario1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2019-12-10  0:39:56